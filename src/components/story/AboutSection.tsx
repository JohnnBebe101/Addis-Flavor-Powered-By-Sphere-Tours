    ...
    <>
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div
            className={`p-6 rounded-2xl border transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col justify-between ${
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm opacity-75 leading-relaxed font-sans">{content.offer1Desc}</p>
            </div>
            <button
              onClick={onBookClick}
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm opacity-75 leading-relaxed font-sans">{content.offer2Desc}</p>
            </div>
            <button
              onClick={onBookClick}
              className="mt-6 inline-flex items-center space-x-1 text-xs font-mono uppercase text-gold hover:text-coffee-red transition-colors font-bold self-start"
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-sm opacity-75 leading-relaxed font-sans">{content.offer3Desc}</p>
            </div>
            <button
              onClick={onBookClick}
              className="mt-6 inline-flex items-center space-x-1 text-xs font-mono uppercase text-gold hover:text-coffee-red transition-colors font-bold self-start"
      ...
      >
        <div className="relative z-10 max-w-xl ml-6 sm:ml-12 mr-6 text-linen-white space-y-4">
          ...
          <div className="flex items-center space-x-2 text-xs font-mono text-gold uppercase tracking-wider font-bold">
            ...
            <span>{content.bannerAuthor}</span>
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="inline-flex items-center space-x-2 text-gold font-mono uppercase tracking-widest text-xs">
            <Compass className="w-4 h-4 text-coffee-red" />
            <span>{content.startedTitle}</span>
          </div>
