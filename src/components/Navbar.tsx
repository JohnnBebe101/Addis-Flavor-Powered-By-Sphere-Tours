              ...
              <div className="space-y-6 pt-6 border-t border-current/10 mt-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <a
                    href="#login"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className={`flex items-center justify-center space-x-1.5 py-3 rounded-xl border text-xs uppercase tracking-wider font-bold transition-all ${
                      isGlobalDark 
                        ? 'border-linen-white/15 hover:bg-white/5 text-linen-white' 
                        : 'border-teal/15 hover:bg-teal/5 text-teal'
                    }`}
                  >
                    <LogIn className="w-3.5 h-3.5" />
                    <span>{translations.navLogin}</span>
                  </a>
                  <a
                    href="#signup"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center justify-center space-x-1.5 py-3 rounded-xl bg-coffee-red text-linen-white text-xs uppercase tracking-wider font-bold hover:bg-coffee-red/90 transition-all shadow-md"
                  >
                    <UserPlus className="w-3.5 h-3.5" />
                    <span>{translations.navSignUp}</span>
                  </a>
                </div>
