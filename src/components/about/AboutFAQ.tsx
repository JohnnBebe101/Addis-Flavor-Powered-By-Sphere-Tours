    ...
    >
      ...
      <div className="max-w-3xl mx-auto text-center space-y-4">
        ...
        <div className="inline-flex items-center space-x-2 text-gold font-mono uppercase tracking-widest text-xs">
          {' '}
          <HelpCircle className="w-4 h-4 text-coffee-red" /> <span>FAQ</span>{' '}
        </div>{' '}
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        {[
          ...
          return (
            <div
              key={idx}
              className="rounded-2xl border transition-all duration-300 bg-sandstone/15 border-teal/5 hover:border-gold/55"
            >
              {' '}
              <button
