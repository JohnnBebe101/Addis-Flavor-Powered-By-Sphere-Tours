        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border border-teal/10 bg-sandstone/50 hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <h3 className="text-xl font-serif font-bold text-teal text-center mb-3">
                Local Knowledge & Expertise
              </h3>
              <p className="text-teal/70 text-center">
                Our guides are born and raised in Addis Ababa, speak fluent English, and share
                stories you won't find in guidebooks. We live here, guide here, and know the city's
                hidden gems.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-teal/10 bg-sandstone/50 hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-teal/70 text-center">
                Choose from private tours (1-6 people) or small groups (max 6). Flexible pickup
                times, personalized attention, and itineraries tailored to your interests.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-teal/10 bg-sandstone/50 hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-teal/70 text-center">
                Complimentary hotel pickup from all central Addis Ababa locations (Bole, Piassa,
                Meskel Square). Airport transfers available. Modern, air-conditioned vehicles.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl border border-teal/10 bg-linen-white hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-teal/70 text-center">
                Every guide is personally interviewed, background-checked, and trained for safety
                and expertise. We visit each guide's home and meet their family.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-teal/10 bg-linen-white hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-teal/70 text-center">
                Our guides are trained in safe food preparation, clean water, and managing dietary
                needs including severe allergies. Bottled water provided on all tours.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl border border-teal/10 bg-linen-white hover:border-gold/40 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-teal/70 text-center">
                Located in secure, highly accessible neighborhoods. Optional Sphere Travel transport
                arrangements available with professional drivers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl border border-teal/10 bg-sandstone/50">
              ...
              <ul className="space-y-2 text-teal/70">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Free cancellation up
                  to 24 hours before tour start time
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Cancellations within
                  24 hours or no-shows are non-refundable
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Weather-related
                  cancellations: full refund or free rescheduling
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Refunds processed
            ...
            <div className="p-8 rounded-2xl border border-teal/10 bg-sandstone/50">
              ...
              <ul className="space-y-2 text-teal/70">
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Book direct and save
                  15% vs. GetYourGuide/Viator
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> No hidden fees
                  &mdash; all entrance fees, guide, vehicle included
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Children (6-17)
                  discounted, infants (0-5) free
                </li>
                <li className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-emerald-600 flex-shrink-0" /> Pay in USD, EUR, or
                  ETB &mdash; cash or card
                </li>
              </ul>
            </div>
          </div>
