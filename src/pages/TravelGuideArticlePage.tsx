...
export const TravelGuideArticlePage: React.FC = () => {
  ...
  const article =
    travelGuideData.articles.find((a) => a.slug === slug) || travelGuideData.articles[0];
      ...
      <section className="py-16 bg-sandstone/10 border-b border-teal/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-6">
            <a
              href="/travel-guide/"
              className="flex items-center gap-2 text-teal/70 hover:text-coffee-red transition-colors"
            >
      ...
      <article className="py-16 bg-linen-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-teal max-w-none">
            <div className="text-teal/70 leading-relaxed mb-8 text-lg">{article.content}</div>
            ...
            <div className="bg-sandstone/50 rounded-2xl p-8 border border-teal/10 mb-12">
              ...
              <ul className="space-y-3 list-disc list-inside text-teal/70">
                ...
                <li>
                  Respect local customs: dress modestly, remove shoes at churches, use right hand
                  for eating
                </li>
                <li>
                  Stay hydrated: Addis Ababa is at 2,400m altitude - take it easy your first day
                </li>
                <li>
                  Try the coffee ceremony: it's a cultural experience, not just a caffeine fix
                </li>
                <li>
                  Use reputable tour operators: licensed guides, insured vehicles, fair prices
                </li>
              </ul>
            </div>
            ...
            <div className="bg-teal text-linen-white rounded-2xl p-8 mb-12">
              ...
              <p className="text-linen-white/80 mb-6 max-w-xl mx-auto">
                Let our expert local guides show you the real Ethiopia. From ancient history to
                modern culture, we'll craft the perfect journey for you.
              </p>
      ...
      <section className="py-16 bg-sandstone/10 border-t border-teal/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {travelGuideData.articles
              .filter((a) => a.slug !== 'best-time-to-visit')
              .slice(0, 3)
              .map((a) => (
                <a
                  key={a.slug}
                ...
                >
                  ...
                  <h3 className="text-lg font-serif font-bold text-teal mb-2">{a.title}</h3>
                  <p className="text-sm text-teal/70 leading-relaxed mb-4 flex-1">{a.excerpt}</p>
