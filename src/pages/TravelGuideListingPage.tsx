      ...
      <section className="py-16 bg-sandstone/10 border-b border-teal/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-teal/70 max-w-3xl mx-auto">
            Expert travel guides for Addis Ababa and Ethiopia: best time to visit, what to wear,
            coffee ceremony etiquette, day trip itineraries, practical tips. Plan your perfect
            Ethiopian adventure.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {categories.map((cat) => (
              <button
                key={cat.id}
                className="px-4 py-2 rounded-full border border-teal/20 text-teal hover:bg-teal/5 text-sm font-mono uppercase font-bold"
              >
                {cat.name}
              </button>
            ))}
            ...
            {travelGuideData.articles.map((article) => {
              return (
                <a
                  ...
                  className="group bg-linen-white rounded-2xl p-6 border border-teal/10 hover:border-gold/40 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-full flex flex-col"
                >
      ...
      <section className="py-16 bg-teal text-linen-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-linen-white/80 mb-8 max-w-2xl mx-auto">
            From ancient history to modern culture, our expert guides help you experience the real
            Ethiopia.
          </p>
